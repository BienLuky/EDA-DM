...
from task_config import church_get_parser
from calibration import TDAC_church_calib_data_generator
...
if __name__ == "__main__":
    ...
    if args.ptq:
        ...
        cali_data = TDAC_church_calib_data_generator(
            model,
            args,
