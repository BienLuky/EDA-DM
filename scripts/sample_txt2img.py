...
from qdiff_control import set_act_quantize_params_Stable, set_weight_quantize_params_Stable, recon_block_Qmodel, get_prompts, center_resize_image
...
from task_config import coco_get_parser
from calibration import TDAC_coco_calib_data_generator
...
if __name__ == "__main__":
    ...
    if not args.from_file:
        ...
        data = [args.n_samples * [prompt]]
    else:
        logging.info(f"reading prompts from {args.from_file}")
        args.list_prompts = get_prompts(args.from_file)
        data = args.list_prompts[:args.n_samples]
    ...
    if args.ptq:
        ...
        cali_data = TDAC_coco_calib_data_generator(
            model,
            args,
