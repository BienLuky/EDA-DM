...
def get_parser():
    ...
    parser.add_argument(
        ...
        default="/dataset/LSUN/bedrooms/train_1000k"
    )
    parser.add_argument(
        "-c",
        "--custom_steps",
...
def backward_t_calib_data_generator(
    ...
    plt.savefig('./Bedroom_PTQ_t_num.png')
...
def backward_featrue_greedy_calib_data_generator(
    ...
    plt.savefig('./Bedroom_dense_num.png')
    ...
    plt.savefig('./Bedroom_Cos_dis.png')
